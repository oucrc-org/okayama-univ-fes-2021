      ...
      <div class="relative items-center w-full px-8 py-3 mx-auto lg:py-6 max-w-screen-lg">
        <div class="alert alert-info mb-5">
          <div class="flex-1">
            ...
            <label class="mx-3">ステージ企画のご視聴ありがとうございました。来年度の学祭のため、アンケートにご協力ください！</label>
          </div>
          <div class="flex-none">
            <a
        ...
        <div class="relative mt-10 px-6 z-10">
          ...
          <div class="grid grid-cols-2 gap-4 mt-10 sm:mt-20">
            ...
            <div class="col-span-2 md:col-span-1 text-center md:text-left md:pl-3">
              <div
                class="border-3 border-white bg-white inline-block font-medium text-center text-themeColor text-lg tracking-wider rounded-full w-11/12 md:w-72 py-3 cursor-not-allowed"
              >
                終了しました
              </div>
            </div>
