    ...
    <BodyWithHeader title="学長からのメッセージ">
      ...
      <div class="p-1">
        <p class="tracking-wide leading-loose text-sm my-1">
          皆さん、こんにちは。岡山大学長の槇野博史です。この度は、令和3年度オンライン岡山大学祭をご覧いただき、誠にありがとうございます。<br>
          今年度も、昨年度に引き続き、新型コロナウイルス感染症の感染拡大防止の観点から、例年のように来場者を迎えて大学祭を実施することは見送ることとなり、昨年度同様にオンラインでの大学祭の開催となりました。
          今年度は、大学祭実行委員会と校友会が一丸となって共同で企画していますので、昨年度以上に皆様に楽しんでいただけることと思います。<br>

          今回のオンライン大学祭では、参加する約79団体が、それぞれに趣向をこらして、動画や作品をWeb上で発表する形となっています。
          また昨年度なかった試みとして、プロの芸人の方によるお笑いライブや、各団体のステージでのパフォーマンスを生配信で行う予定です。
          どちらも岡山大学らしさを存分に盛り込みつつ皆様に楽しんでいただけるよう、学生が主体となって工夫を凝らし、自ら取り組んでまいりましたので、ぜひ一人でも多くの方にご覧いただければと思います。<br>

          コロナ禍で、今年度も正課外活動の制限が続いたり、学外での試合や大会が中止になったりと、各団体の中には、活動の成果を発表する機会まで奪われたところが少なくありません。
          そうした中、オンライン大学祭をご覧いただく皆様に、各団体のパフォーマンスを見ていただいたり、活動内容を知っていただいたりできることは、とてもありがたい機会であり、日々の練習の成果を発揮するために、各団体も準備を進めてまいりました。<br>
          岡山大学らしいバラエティーに富んださまざまな団体が、皆様に楽しんでいただける動画や作品、パフォーマンスを披露しますので、是非一つ一つの企画を存分にお楽しみください。
    ...
    <BodyWithHeader title="岡山大学について">
      ...
      <div class="p-1">
        <p class="tracking-wide leading-loose text-sm my-6 mx-5">
          ...
          また、本学は、SDGsを推進しており、学内のみならず地域社会と一体になった取り組みも進めています。正課外活動を行う団体は、文化系の校友会が35団体、体育系の校友会が49団体、医療系地区等の校友会が42団体あるほか、同好会（サークル）も54団体あり、幅広い活動を行っています。
